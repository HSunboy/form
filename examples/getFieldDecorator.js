...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rc_form__ = __webpack_require__(126);
...
var Form = function (_React$Component) {
  ...
  function Form() {
    ...
    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      showName: true,
      hideName: false
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Form, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          hideName = _state.hideName;


      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        'form',
        { onSubmit: this.onSubmit },
        !hideName ? showName ? this.props.form.getFieldDecorator('nameTest', {
          initialValue: '',
          rules: [{
            required: true,
            message: 'What\'s your name?'
          }]
        })(__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', null)) : [this.props.form.getFieldDecorator('nameTest', {
          initialValue: '',
          rules: [{
            required: true,
            message: 'What\'s your test name?'
          }]
        })(__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', { ref: function ref() {}, key: '2' }))] : null,
        !hideName && this.nameDecorator(__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', {
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'a',
          { style: { color: 'skyblue' }, onClick: function onClick() {
