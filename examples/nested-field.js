...
/* harmony export (immutable) */ __webpack_exports__["c"] = getValueFromEvent;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = mirror;
/* harmony export (immutable) */ __webpack_exports__["e"] = hasRules;
/* unused harmony export startsWith */
/* harmony export (immutable) */ __webpack_exports__["a"] = getParams;
/* harmony export (immutable) */ __webpack_exports__["d"] = getNameIfNested;
/* harmony export (immutable) */ __webpack_exports__["k"] = flatFieldNames;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = normalizeValidateRules;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__createFieldsStore__ = __webpack_require__(504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils__ = __webpack_require__(297);
...
function createBaseForm() {
  ...
  var mapPropsToFields = option.mapPropsToFields,
      ...
      mapProps = _option$mapProps === undefined ? __WEBPACK_IMPORTED_MODULE_12__utils__["b" /* mirror */] : _option$mapProps,
    ...
    var Form = __WEBPACK_IMPORTED_MODULE_5_create_react_class___default()({
      ...
      onCollect: function onCollect(name_, action) {
        ...
        var fieldContent = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, field, {
          dirty: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["e" /* hasRules */])(validate)
        });
      ...
      getFieldDecorator: function getFieldDecorator(name, fieldOption) {
        ...
        return function (fieldElem) {
          ...
          if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["f" /* isEmptyObject */])(fieldMeta)) {
      ...
      getFieldProps: function getFieldProps(name) {
        ...
        var nameIfNested = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["d" /* getNameIfNested */])(name);
        ...
        var validateRules = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["g" /* normalizeValidateRules */])(validate, rules, validateTrigger);
      ...
      getRules: function getRules(fieldMeta, action) {
        ...
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["h" /* flattenArray */])(actionRules);
      },
      ...
      setFieldsValue: function setFieldsValue(fieldsValue) {
        ...
        var virtualPaths = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["i" /* getVirtualPaths */])(fieldsMeta);
        Object.keys(fieldsValue).forEach(function (name) {
          var value = fieldsValue[name];
          if (fieldsMeta[name] && fieldsMeta[name].virtual) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["j" /* clearVirtualField */])(name, fields, fieldsMeta);
      ...
      saveRef: function saveRef(name, _, component) {
        console.log('ref', name, component);
        if (!component) {
      ...
      validateFieldsInternal: function validateFieldsInternal(fields, _ref, callback) {
        ...
        if (callback && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["f" /* isEmptyObject */])(allFields)) {
          callback(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["f" /* isEmptyObject */])(alreadyErrors) ? null : alreadyErrors, this.fieldsStore.getFieldsValue(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["k" /* flatFieldNames */])(fieldNames)));
          return;
        }
        ...
        validator.validate(allValues, options, function (errors) {
          ...
          if (callback) {
            ...
            callback(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["f" /* isEmptyObject */])(errorsGroup) ? null : errorsGroup, _this5.fieldsStore.getFieldsValue(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["k" /* flatFieldNames */])(fieldNames)));
          }
        });
      },
      validateFields: function validateFields(ns, opt, cb) {
        ...
        var _getParams = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["a" /* getParams */])(ns, opt, cb),
        ...
        var fields = fieldNames.filter(function (name) {
          ...
          return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["e" /* hasRules */])(fieldMeta.validate);
        }).map(function (name) {
        ...
        if (!fields.length) {
          if (callback) {
            callback(null, this.fieldsStore.getFieldsValue(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils__["k" /* flatFieldNames */])(fieldNames)));
          }
          return;
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_createDOMForm__ = __webpack_require__(503);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dom_scroll_into_view__ = __webpack_require__(191);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_has__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__createBaseForm__ = __webpack_require__(425);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__createForm__ = __webpack_require__(505);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(297);
...
var mixin = {
  ...
  validateFieldsAndScroll: function validateFieldsAndScroll(ns, opt, cb) {
    ...
    var _getParams = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils__["a" /* getParams */])(ns, opt, cb),
        names = _getParams.names,
        callback = _getParams.callback,
        options = _getParams.options;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils__ = __webpack_require__(297);
  ...
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(FieldsStore, [{
    ...
    value: function setFields(fields) {
      ...
      Object.keys(fieldsMeta).forEach(function (f) {
        var _getNameIfNested = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["d" /* getNameIfNested */])(f),
    ...
    value: function getValueFromFields(name, fields) {
      ...
      if (fieldsMeta[name] && fieldsMeta[name].virtual) {
        ...
        Object.keys(fieldsMeta).forEach(function (fieldKey) {
          var nameIfNested = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["d" /* getNameIfNested */])(fieldKey);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getFieldsValue = function (names) {
    var fields = names || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["k" /* flatFieldNames */])(_this3.getValidFieldsName());
    var allValues = {};
  ...
  this.setFieldsInitialValue = function (initialValues) {
    ...
    var virtualPaths = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["i" /* getVirtualPaths */])(fieldsMeta);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBaseForm__ = __webpack_require__(425);
